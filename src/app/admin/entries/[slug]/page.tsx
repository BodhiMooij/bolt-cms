        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded border border-zinc-300 bg-white px-3 py-2 font-mono text-zinc-900 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100"
          ...
          <div>
            ...
            <textarea
              ...
              rows={16}
              className="w-full rounded border border-zinc-300 bg-white px-3 py-2 font-mono text-sm text-zinc-900 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100"
              spellCheck={false}
            />
          </div>
        </div>
            ...
            <button
              ...
              onClick={async () => {
                await fetch(
                  ...
                  { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ isPublished: !entry.isPublished }) }
                );
